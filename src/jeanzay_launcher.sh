...
--mode test --dataset dataset_rh_2class-jeanzay --labels pipelines --image_size 56 \
--c_dim 2 --batch_size 1 --data_dir data \
--sample_dir samples-2class-100000iters --log_dir logs \
--model_save_dir models-2class --test_iters 100000 